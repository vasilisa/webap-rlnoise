...
class Intro_Survey extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      block_number: 0, // change for test purposes to 6 to skip  
      newblock_frame: true, 
  ...
  return (
      <div>
        <div className="IntroConsentText">
          <center>
          <p><span className="bold">INFORMATION FOR THE PARTICIPANT</span></p></center>
          <p></p>
          ...
          <ul>
          <span className="bold">Three types of questions</span> will be asked, relating to:
          <p></p>
          ...
          <p>All your answers will be treated in a <span className="bold">strictly confidential and anonymous</span> manner. 
          ...
          <p><span className="bold">By checking this box, I confirm that I am at least 18 years old, and have read and fully understood the above information.</span></p>
        </div>
        <div>
          <label>
            <Checkbox
