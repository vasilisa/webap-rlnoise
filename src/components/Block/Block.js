...
render()
  { 
    ...
    {
      text = <div className='textbox'> <p>This is a <span className="bold">complete</span> feedback block: you will see <span className="bold">both </span> points of the <span className="bold">chosen</span> and <span className= "bold">unchosen</span> slot machines.</p> 
                <div className="translate"/>
                <img className="introsymbol"  src={require('../../images/symbol_shape_0_grate_None_color_3.png')} alt='introsymbol'/> 
                <img className="introsymbol"  src={require('../../images/symbol_shape_2_grate_None_color_0.png')} alt='introsymbol'/> 
                </div>
